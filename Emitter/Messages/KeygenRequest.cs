...
namespace Emitter.Messages
{
    ...
    public class KeygenRequest
    {
        ...
        {
            var keyType = "";
            if ((Type & SecurityAccess.Read) != 0)
                keyType += "r";
            if ((Type & SecurityAccess.Write) != 0)
                keyType += "w";
            if ((Type & SecurityAccess.Store) != 0)
                keyType += "s";
            if ((Type & SecurityAccess.Load) != 0)
                keyType += "l";
            if ((Type & SecurityAccess.Presence) != 0)
                keyType += "p";
