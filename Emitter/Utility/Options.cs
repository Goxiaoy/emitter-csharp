...
namespace Emitter.Utility
{
    public static class Options
    {
        ...
        public static string WithTTL(int ttl)
        {
            return "ttl=" + ttl;
        }

        public static string WithoutEcho()
        {
            return "me=0";
        }

        public static string WithLast(int last)
        {
            return "last=" + last;
        }

        public static string WithRetain()
        {
            return Retain;
        }
        ...
        public static string WithFrom(DateTime from)
        {
            return "from=" + ToTimestamp(from);
        }

        public static string WithUntil(DateTime until)
        {
            return "until=" + ToTimestamp(until);
        }
    }
}